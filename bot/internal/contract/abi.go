...
const StableArbV2V3ABI = `[
  {"type":"constructor","inputs":[{"name":"_v2Router","type":"address"},{"name":"_v3Router","type":"address"},{"name":"_usdt0","type":"address"},{"name":"_wgusdt","type":"address"}],"stateMutability":"nonpayable"},
  ...
  {"type":"function","name":"wgusdt","inputs":[],"outputs":[{"name":"","type":"address"}],"stateMutability":"view"},
...
const V2FactoryABI = `[
  ...
  {"constant":true,"inputs":[{"internalType":"address","name":"","type":"address"},{"internalType":"address","name":"","type":"address"}],"name":"getPair","outputs":[{"internalType":"address","name":"","type":"address"}],"type":"function"}
]`
...
// V3 Quoter V2 ABI — tuple input (standard Uniswap V3 Quoter V2 interface).
const QuoterABI = `[
